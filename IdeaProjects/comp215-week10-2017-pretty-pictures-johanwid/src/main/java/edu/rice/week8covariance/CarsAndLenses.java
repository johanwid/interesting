...
public interface CarsAndLenses {
  ...
  class Car {
    ...
    public static final Lens<Car, String> Make =
        lens(car -> car.make,
            (car, newMake) -> new Car(newMake, car.model, car.year));

    public static final Lens<Car, String> Model =
        lens(car -> car.model,
            (car, newModel) -> new Car(car.make, newModel, car.year));

    public static final Lens<Car, Integer> Year =
        lens(car -> car.year,
            (car, newYear) -> new Car(car.make, car.model, newYear));
  }
  ...
  class AstonMartin extends Car {
    ...
    public static final Lens<AstonMartin, String> Model =
        lens(car -> car.model,
            (car, newModel) -> new AstonMartin(newModel, car.year));

    public static final Lens<AstonMartin, Integer> Year =
        lens(car -> car.year,
            (car, newYear) -> new AstonMartin(car.model, newYear));
  }
  ...
  class AstonMartinDB5 extends AstonMartin {
    ...
    public static final Lens<AstonMartinDB5, Integer> Year =
        lens(car -> car.year,
            (car, newYear) -> new AstonMartinDB5(newYear));
  }
  ...
  class BondDB5 extends AstonMartinDB5 {
    ...
    public static final Lens<BondDB5, Integer> Bullets =
        lens(car -> car.numBullets,
            (car, numBullets) -> new BondDB5(numBullets));
    ...
    /**
     * Adds the given number of bullets to the BondDB5's weapons bay. If you'd prefer
     * to leave the original BondDB5 alone, you may prefer the {@link #Bullets} lens.
     */
